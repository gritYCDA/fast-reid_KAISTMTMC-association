...
class Baseline_RGBT(nn.Module):
    """
    RGBT Baseline architecture. Any models that contains the following two components:
    ...
    def from_config(cls, cfg):
        ...
        return {
            ...
            'RGBT_type': cfg.MODEL.BACKBONE.NAME,
            'loss_kwargs':
                {
                    # loss name
    ...
    def preprocess_image(self, batched_inputs):
        ...
        if isinstance(batched_inputs, dict):
            ...
            thermals = batched_inputs['thermals']
        ...
        thermal_mean = self.pixel_mean.mean().repeat(3).view(1,-1,1,1)
        thermal_std = self.pixel_std.mean().repeat(3).view(1,-1,1,1)
        thermals.sub_(thermal_mean).div_(thermal_std)
        return images, thermals
